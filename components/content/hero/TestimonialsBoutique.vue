<template>
    <div class="relative max-w-[95rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <blockquote class="text-center lg:mx-auto lg:w-3/5">
        <div class="mt-6 lg:mt-10">
          <p class="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
            ...
            <span class="relative z-10 italic jakarta-regular text-gray-800">
              <ContentSlot name="testimonialText" />
            </span>
          </p>
        </div>
        <footer class="mt-6">
          <div class="font-semibold text-gray-800">
            <ContentSlot name="testimonialAuthor" />
          </div>
          <div class="text-sm text-gray-500">
            <ContentSlot name="testimonialSource" />
          </div>
        </footer>
      </blockquote>
    </div>
